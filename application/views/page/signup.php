...
<div class="col-md-12 pad-top-btm-30">
    <div class="col-md-6 col-md-offset-3" style="padding-top: 30px; padding-bottom: 70px;">
        <div class="panel panel-default pad-top-btm-30">
            <h5 class="bold" style="margin-left: 30px; font-size: 20px;">Daftar Menjadi Admin</h5>
            <hr>
            <div class="form-horizontal pad-all-10">
                <?php echo form_open('base/signup/signup_process'); ?>
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <font style="color: #D9534F;"><?php echo form_error('nama'); ?></font>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="password" class="form-control" placeholder="Password" name="passconf" value="<?php echo set_value('passconf'); ?>">
                    </div>
                    <div class="col-md-3">
                        <font style="color: #D9534F;"><?php echo form_error('passconf'); ?></font>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-3 col-md-6">
                        <button type="submit" class="btn btn-primary btn-sm bold">Daftar</button>
                    </div>
                </div>
                </form>
            </div>
